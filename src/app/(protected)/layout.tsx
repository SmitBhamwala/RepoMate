    ...
    <SessionProvider>
      <SidebarProvider>
        ...
        <main className="w-full p-2 flex flex-col items-center">
          ...
          <div className="w-full border-sidebar-border bg-sidebar border shadow rounded-md overflow-x-hidden overflow-y-scroll h-[calc(100vh-10rem)] lg:h-[calc(100svh-6rem)] p-4">
            {children}
          </div>
